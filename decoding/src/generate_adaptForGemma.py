...
def main(
    ...
    model, tokenizer, generation_config = load_model_tokenizer_init_left(model_name_or_path, adapter_path)
    ...
    try:
        ...
        querys = [data["instruction"] for data in dataset]
